...
const APP_DATA = [
    ...
    },
    {
        id: 'mental-age',
        name: '정신 연령 스타일 챌린지',
        shortDesc: '7개 미니게임과 투명한 평균 점수.',
        description: '기억, 반응, 패턴 등 7개 미니게임의 영역별 점수와 산술 평균을 보여 주는 오락용 챌린지입니다.',
        icon: '🎯',
        color: '#0891b2',
        category: 'test',
        ...
        popularity: 0,
        i18n: {
            en: { name: 'Mental Age-Style Challenge', shortDesc: 'Seven mini-games with a transparent average score.' },
            zh: { name: '心理年龄风格挑战', shortDesc: '7个小游戏和透明的平均分。' },
            hi: { name: 'मानसिक-उम्र शैली चुनौती', shortDesc: 'सात मिनी-गेम और पारदर्शी औसत स्कोर।' },
            ru: { name: 'Задание в стиле ментального возраста', shortDesc: 'Семь мини-игр и прозрачный средний балл.' },
            ja: { name: '精神年齢スタイル・チャレンジ', shortDesc: '7つのミニゲームと透明な平均スコア。' },
            es: { name: 'Reto de estilo edad mental', shortDesc: 'Siete minijuegos con un promedio transparente.' },
            pt: { name: 'Desafio estilo idade mental', shortDesc: 'Sete minijogos com uma média transparente.' },
            id: { name: 'Tantangan bergaya usia mental', shortDesc: 'Tujuh gim mini dengan skor rata-rata transparan.' },
            tr: { name: 'Zihinsel yaş tarzı mücadele', shortDesc: 'Şeffaf ortalamalı yedi mini oyun.' },
            de: { name: 'Mental-Age-Rätsel', shortDesc: 'Sieben Mini-Spiele mit transparentem Durchschnittswert.' },
            fr: { name: 'Défi de style âge mental', shortDesc: 'Sept mini-jeux avec une moyenne transparente.' }
        }
    },
    ...
    },
    {
        ...
        color: '#ec4899',
        category: 'test',
        tags: ['심리', '애착', '관계', 'psychology', 'attachment', 'relationships', 'dating', 'love'],
